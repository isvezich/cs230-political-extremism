...
def metrics_to_plot(history, params):
    ...
    json.dump(history_dict, open(f"history_model:{params.model_version}_h1units:{params.h1_units}_h2units:{params.h2_units}_l2reglambda:{params.l2_reg_lambda}_lr:{params.learning_rate}_batchsize:{params.batch_size}_dropout:{params.dropout_rate}.json", 'w'))
    ...
    plt.savefig(f"plt_model:{params.model_version}_h1units:{params.h1_units}_h2units:{params.h2_units}_l2reglambda:{params.l2_reg_lambda}_lr:{params.learning_rate}_batchsize:{params.batch_size}_dropout:{params.dropout_rate}.png")
    plt.show()
